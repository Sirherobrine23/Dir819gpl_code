...
void sendSigToLogicWpsLock()
{
#ifdef LINUX
	/*
	     Notify user space application that WPS Lock Setup.
	*/
#define SIG_RA0_WPS_LOCK_SETUP  42 //(SIGRTMIN+10)
#define WSC_LOGIC_APPNAME  "logic"
...
#endif
		{
				if(!strcmp(p->comm, WSC_LOGIC_APPNAME))
				{
					send_sig(SIG_RA0_WPS_LOCK_SETUP, p, 0);
				}
		}
	...
	IN  PWSC_CTRL		pWscControl)
{
	...
	*/
	...
	{		
		...
		sendSigToLogicWpsLock(); //linsd add notify logic 
