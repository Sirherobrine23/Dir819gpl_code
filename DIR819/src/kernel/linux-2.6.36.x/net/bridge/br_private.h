...
/* TBS_TAG: by pengyao 2012-05-23  Desc: add IGMP Snooping support */
#if defined(CONFIG_IGMP_SNOOPING)
#include <linux/igmp.h>
#include <linux/in.h>
#endif

/* TBS_TAG: by PengYao 2013-03-11 Desc: Added tbs_nfp flags for TBS_NFP */
#include "autoconf.h"
...
struct net_bridge_mc_fdb_entry
{
    ...
    /* TBS_TAG: by pengyao 2013-03-11 Desc:group_addr for tbs_nfp forward*/
    struct in_addr	        group_addr;

    /* TBS_TAG: by pengyao 2012-2-28 Desc:define mc_fdb rcu */
    //struct rcu_head			rcu;
 ...
 */
#if defined(CONFIG_IGMP_SNOOPING)
extern int igmpsnooping;
extern int multicast2unicastEn;
extern int mc_forward(struct net_bridge *br, struct sk_buff *skb, unsigned char *dest,int forward);
extern int br_mc_fdb_add(struct net_bridge *br, struct net_bridge_port *prt,
        unsigned char *host, int mode, struct in_addr *src, unsigned int *group);
extern int br_mc_fdb_add_by_host(struct net_bridge *br, struct net_bridge_port *prt,
    unsigned char *host, int mode, struct in_addr *src, unsigned int *group);
...
extern int br_mc_fdb_remove(struct net_bridge *br, struct net_bridge_port *prt,
    unsigned char *host, int mode, struct in_addr *src, unsigned int *group);
...
extern int br_mc_fdb_update(struct net_bridge *br,
				struct net_bridge_port *prt,
				unsigned char *host,
 ...
 */
extern void br_mc_fdb_delete_by_port(struct net_bridge *br,
