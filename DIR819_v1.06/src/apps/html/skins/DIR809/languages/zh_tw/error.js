var SEcode = {
		...
		lang_switchrepeater_invalid : '當無線選擇WPA-Enterprise的安全模式時不可以切換到repeater模式，請先修改安全模式！',
		...
		lang_pri_dns_invalid : '無效的主要 DNS位址!',
		lang_sec_dns_invalid : '無效的Second DNS位址',
		...
		lang_invalid_pptp_server : '無效的PPTP 伺服器IP 位址',
		...
		lang_invalid_l2tp_server : '無效的L2TP 伺服器IP 位址',
		...
		lang_ssid_empty : 'SSID欄位不可以空白!',
		lang_prefix_blank : '「無線網路名稱」的字首或字尾不可以有空白。',
		...
		lang_psk_printable : 'PSK應該是8-63個可列印的字元。',
		...
		lang_passwd_8_63 : '不正確的金鑰長度! 長度應介於為8到63個字元。',
		lang_modechange_warning : '如果更改模式，設備將重新啟動。妳想繼續嗎？'
};                                                                                      
var UEcode = { 
