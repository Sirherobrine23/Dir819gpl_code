...
/*
 * TBS_TAG: by WuGuoxiang at 2012-7-4
 * Desc:Added for route mark
 */
 ...
 */
struct ethtool_tbsmark
{
    u32   cmd;
    u32 def_mark;
    u32 br_mark;
    u8  flags;//tag_TBS_FORWARD_FLAGES
};
/*
 * TBS_END_TAG
 */
...
/*
 * TBS_TAG: by WuGuoxiang at 2012-11-26
 * Desc: Added for route mark
 */
 ...
 * Desc: for tbs forwarding
 */
#define ETHTOOL_STBSMARK    0x00000040 /* Set Tbs forward mark */
#define ETHTOOL_GTBSMARK    0x00000041 /* Get Tbs forward mark */
/*
 * TBS_END_TAG
 */
