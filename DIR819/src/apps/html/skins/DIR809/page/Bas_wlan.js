...
function createChannel_5G_40M()
{
	...
	switch(Radio_list[1][7])
	{
		...
		case 'GB' :
		{
			    new_options = ['36','40','44','48'];
				new_values  = ['36','40','44','48'];
				//new_options = ['36','40','44','48','52','56','60','64','100','104','108','112','116','120','124','128','132','136'];
				//new_values  = ['36','40','44','48','52','56','60','64','100','104','108','112','116','120','124','128','132','136'];
				break;
		}
...
function createChannel_5G_80M()
{
	...
	switch(Radio_list[1][7])
	{
		...
		case 'GB' :
		{
			    new_options = ['36','40','44','48'];
				new_values  = ['36','40','44','48'];
				//new_options = ['36','40','44','48','52','56','60','64','100','104','108','112','116','120','124','128'];
				//new_values  = ['36','40','44','48','52','56','60','64','100','104','108','112','116','120','124','128'];
				break;
		}
