...
/*
   iwpriv命令支持多个配置同时下发，配置
   之间通过, 号隔离。此功能会导致像ssid、
   密码不能包括,号，故增加宏TW_CONFIG_PRIV_SUPPORT_MULTI_NO
   用于取消多配置下发功能。
*/

#define TW_CONFIG_PRIV_SUPPORT_MULTI_NO

#ifdef TW_CONFIG_PRIV_SUPPORT_MULTI_NO
        {

			this_char=(PSTRING)pIoctlCmdStr->u.data.pointer;
