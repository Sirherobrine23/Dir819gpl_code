...
function uiOnload(){
	...
	if (WanV6_Mode == "")
	{
	if(G_IPv4_ProtocolType == "IPv4_6")
	{
			WanV6_Mode = "PPPOE"; //linklocal			
	}
	else
	...
	switch(WanV6_Mode)
	{
		...
		case "PPPOE":
			...
			if(G_Wanipv6Conn['pppIPv6ConnectionStatus'] == "GlobalConnected")
			{
				...
				$("wan_address").innerHTML = G_Wanipv6Conn['pppIPv6Address'] || data_languages.Public.innerHTML.Public022;
				$("wan_address_pl").innerHTML = G_Wanipv6Conn['pppIPv6Address']!= "" ?"/"+G_Wanipv6Conn['pppIPv6PrefixLength'] : "";
			}
