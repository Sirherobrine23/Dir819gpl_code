...
function forInstance(){
	...
	{
		if(G_arrScan2[instanceIdx][2] == Wz_bssid)
		{
			S_arrTemp[G_Idx]=[];
			S_arrTemp[G_Idx][0] = G_arrScan2[instanceIdx][0];
			S_arrTemp[G_Idx][1] = G_arrScan2[instanceIdx][1];
			S_arrTemp[G_Idx][2] = G_arrScan2[instanceIdx][2];
			S_arrTemp[G_Idx][3] = G_arrScan2[instanceIdx][3];
			S_arrTemp[G_Idx][4] = G_arrScan2[instanceIdx][4];
			S_arrTemp[G_Idx][5] = G_arrScan2[instanceIdx][5];
			S_arrTemp[G_Idx][6] = G_arrScan2[instanceIdx][6];
			S_arrTemp[G_Idx][7] = G_arrScan2[instanceIdx][7];
			S_arrTemp[G_Idx][8] = G_arrScan2[instanceIdx][8];
		}	
	}
}
function alertError()
...
function saveWlanChanges()
{
	...
	$("wlrepeaterfinish2").setAttribute("disabled", true);
	
	$F(":InternetGatewayDevice.LANDevice.1.LANHostConfigManagement.DHCPServerEnable", "0");
	
	var path_Client = ":InternetGatewayDevice.LANDevice.1.X_TWSZ-COM_ApCliConfiguration.1.";
	forInstance();	
	var s_ssid    = Wz_ssid;
	...
	$F(":InternetGatewayDevice.LANDevice.1.WLANConfiguration.1." + "AutoChannelEnable" , "0");
	$F(":InternetGatewayDevice.LANDevice.1.WLANConfiguration.1." + "Channel" , s_channel);
	$F(":InternetGatewayDevice.X_TWSZ-COM_Radio.1." + "AutoChannelEnable" , "0");
	$F(":InternetGatewayDevice.X_TWSZ-COM_Radio.1." + "Channel" , s_channel);
	$F(":InternetGatewayDevice.X_TWSZ-COM_Radio.1." + "Standard" , "bgn");
	$F(":InternetGatewayDevice.X_TWSZ-COM_Radio.1." + "OperatingChannelBandwidth" , "40");	
