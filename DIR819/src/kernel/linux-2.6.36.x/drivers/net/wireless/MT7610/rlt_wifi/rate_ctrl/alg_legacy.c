...
VOID APMlmeDynamicTxRateSwitching(RTMP_ADAPTER *pAd)
{
	...
	for (i = 1; i < MaxWcidNum; i++) 
	{
		...
		*/
		if (Rssi > -65) //2014-05-20 improve t-put 
		{
			TrainUp		= 2*(pCurrTxRate->TrainUp);  //2014-5-20 improve t-put
...
#endif /* DOT11_N_SUPPORT */
		{
			...
			TrainUp		= (pCurrTxRate->TrainUp + (pCurrTxRate->TrainUp >> 1)); //2014-5-20 improve t-put 
