var SEcode = {                     
  ...
  8000    : 'Enabled',
	...
	lang_switchrepeater_invalid : 'When the wireless mode of WPA-Enterprise is selected wirelessly, you cannot switch to repeater mode. Please modify the security mode first!',
  ...
  vilidity  : ' invalid!',
  tcpiplan_dhcp_001			  : 'If you change network segment, the device will reboot and DHCP Reservations List will be deleted. \nAre you sure you want to change the LAN IP address or Netmask? ' ,
  ...
  lang_invalid_input                    : 'The input cannot contain the following illegal characters,such as "| & ; $  + > < ? ( ) "',
  lang_PPPoE_invalid_input                    : 'The input cannot contain the following illegal characters,such as "| & ; $  + > < ? ( ) "',
  ...
  lang_modechange_warning   :  'If you change the mode, the device is going to reboot. Do you want to continue?'
};                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
...
var UEcode = {                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
	...
	1932 : 'Invalid idle time! It should be 1~1092',
