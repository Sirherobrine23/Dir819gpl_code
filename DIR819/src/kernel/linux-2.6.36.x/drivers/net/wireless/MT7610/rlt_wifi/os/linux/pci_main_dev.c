...
/*#ifdef KTHREAD_SUPPORT */
	...
	/* add to create common netlink socket to send message to userspace by rongwei on 2014/5/26 */
	tbs_netlink_sock_create( NETLINK_TBS_WLAN_5G, NL_TBS_WLAN1_PID_ENTRY_NAME );
	/* end by rongwei on 2014/5/26 */
...
static VOID __devexit rt2860_remove_one(struct pci_dev *pci_dev)
{
	...
	/* add to destroy the common created netlink socket by rongwei on 2014/5/26 */
	tbs_netlink_sock_destroy( NL_TBS_WLAN1_PID_ENTRY_NAME );
	/* end by rongwei on 2014/5/26 */
