...
{
	{btn_reset,CFG_APP_BTN_MODE_RELEASE_GREATER,5000,0,APP_BTN_EVEN_RESET},
	{btn_wps,CFG_APP_BTN_MODE_RELEASE_GREATER,0,20000,APP_BTN_WPS},
	/* RESET与WPS复用按钮: WPS事件(250ms-3m),Reset事件(>=15s)*/
    //{btn_wps,CFG_APP_BTN_MODE_RELEASE_BETWEEN,250,3000,APP_BTN_EVEN_WLAN0_WPS}, /* WPS按钮(2.4G下行) */
